                ...
                <div className="w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:mb-12 xl:w-6/12">
                  <div className="align-start flex">
                    ...
                    <div className="ml-6 grow">
                      ...
                      <a href="https://www.instagram.com/superstannekretnine/" className="text-neutral-500 dark:text-neutral-200">
                        Instagram
                      </a> <br></br>
                      <a href="https://www.facebook.com/superstannekretnine" className="text-neutral-500 dark:text-neutral-200">
                        Faceboook 
                      </a>
