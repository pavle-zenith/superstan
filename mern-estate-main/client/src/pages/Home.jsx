...
const features = [
...

  {
    name: 'Uvek uz vas',
    description:
      'Besplatna procena vrednosti nekretnine'      
  },
  {
    name: 'Iskusan tim',
    description: 'Iskusni agenti na raspolaganju tokom celog procesa kupoprodaje',
   
  },
  {
    name: 'Pravno osigurani',
    description: 'Prikupljanje dokumentacije za sastavljanje ugovora i pravna podrška',
  ...
  backgroundRepeat: 'no-repeat'
      ...
      <div className="flex pl-4 pr-4 items-center gap-5">
        ...
        <select className="bg-white border border-gray-300 text-gray-700 py-2 px-4 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
          ...
          <option>Surčin</option><option>Sopot</option>
          {/* Other options */}
        </select>
      </div>
      <button className="bg-red-700 p-2 focus:outline-none rounded focus:shadow-outline">
        <svg className="fill-white w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          <path d="M10,2A8,8,0,1,0,18,10,8,8,0,0,0,10,2Zm0,14a6,6,0,1,1,6-6A6,6,0,0,1,10,16Z"/><path d="M21,20a1,1,0,0,0-1-.87H20l-.29-.29a1,1,0,0,0-1.42,0l-2,2a1,1,0,0,0,0,1.42,1,1,0,0,0,.71.29,1,1,0,0,0,.71-.29l2-2Z"/>
        </svg>
      </button>
    </div>
    </div>
      ...
      <div className='max-w-6xl mx-auto p-3 flex flex-col gap-8 my-10'>
        {offerListings && offerListings.length > 0 && (
          <div className=''>
            <div className='my-3'>
              <h2 className='text-2xl font-semibold text-slate-600'>Najnovije nekretnine</h2>
              <Link className='text-sm text-blue-800 hover:underline' to={'/search?offer=true'}>Prikaži više</Link>
            </div>
        ...
        {saleListings && saleListings.length > 0 && (
          <div className=''>
            <div className='my-3'>
              ...
              <Link className='text-sm text-blue-800 hover:underline' to={'/search?type=sale'}>Prikaži više</Link>
            </div>
            <div className='flex flex-wrap gap-4'>
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:pr-8 lg:pt-4">
            <div className="lg:max-w-lg">
              <h2 className="text-base font-semibold leading-7 text-red-600">O nama</h2>
              <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Brzo i sigurno prodajte i izdajte svoju nekretninu</p>
            ...
            <Link
          to={'/search'} 
          className='button-container mx-auto flex-none mt-5 bg-red-700 hover:bg-red-700 text-white hover:text-white font-bold py-2 px-4 rounded'
